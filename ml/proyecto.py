...
errors = ((y_test - y_pred_test) ** 2).flatten() 
plt.figure(figsize=(10, 5))
sns.barplot(x=np.arange(len(errors)), y=errors, color='purple', alpha=0.7)
plt.xlabel("Índice de muestra")
plt.ylabel("Error cuadrático (MSE)")
plt.title("Error cuadrático medio (MSE) en las muestras de prueba")
plt.xticks([]) 
